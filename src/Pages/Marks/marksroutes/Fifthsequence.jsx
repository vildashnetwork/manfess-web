// src/Pages/Marks/marksroutes/FifthSequence.jsx
import React, { useEffect, useRef, useState } from "react";
import { useNavigate } from "react-router-dom";
import axios from "axios"
export default function Fifthsequence() {
 ...
 const [loading, setloading] = useState(false)
  const getresult = async ()=>{
    try{
      setloading(true)
 const res = await axios.get("https://manfess-backend.onrender.com/api/fifthsequence ")
